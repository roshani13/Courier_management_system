  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="clienthome.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
        <li class="dropdown">
...
<DIV class="COL-SM-6">
  ...
  <div class="form-group">
    <a href="trackinghelpclient.php"><h4 style="text-align:center;color:navy" label class="control-label col-sm-10" for="Help Me">*Help Me to track</a></h4></label>
     <div class="col-sm-1">
     </div>
 </div>
  <div class="col-sm-1">
...
<button type=submit class="btn btn-info btn-lg block " >Go</button>
&nbsp&nbsp&nbsp&nbsp <button type=button class="btn btn-info btn-lg block" id="Cancle">Cancle</button><br><br>
</div>
     </div>
   </div>
